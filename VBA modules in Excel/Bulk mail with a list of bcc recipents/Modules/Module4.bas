...
Application.ScreenUpdating = False
   ...
   With emailTemplate
    ...
    'Do additional formatting on the BCC and Subject lines, add the body text from the spreadsheet, and send with a specify Date & Time.
       .SendUsingAccount = OutAccount
       .BCC = SDest
       .Subject = ActiveSheet.Cells(2, 1).Value
       .DeferredDeliveryTime = Range("E8") + Range("F8")
       .Display
   End With
   If LastRow > 302 Then
        ...
        Else: End If
   Else: MsgBox LastRow & "emails have been sent!"
